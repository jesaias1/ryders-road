...
{
    public sealed class PlayerInputRouter : IDevelopmentPlayerInputSource, IFlowSteeringInputSource, IHeldJumpInputSource
    {
        ...
        private void SampleTouch()
        {
            ...
            JumpHeld = (_touch as IHeldJumpInputSource)?.JumpHeld ?? false;
