...
{
    public enum CampaignTrialMode { None, Accepted, FlowManual, FlowLanding, PreviousFlow }
    ...
    public static class CampaignFlowTrial
    {
        ...
        public static bool UsesCandidate => Mode == CampaignTrialMode.FlowManual || Mode == CampaignTrialMode.FlowLanding || Mode == CampaignTrialMode.PreviousFlow;
        public static string MovementResource => !UsesCandidate ? "MovementProfiles/Movement_Default"
